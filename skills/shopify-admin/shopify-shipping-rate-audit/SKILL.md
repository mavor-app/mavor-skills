---
name: shopify-shipping-rate-audit
displayName: Shipping Rate Audit
description: >-
  Read-only: walks every delivery profile and zone to verify each has at least
  one valid shipping rate, surfacing zones with no rates or only manual rates.
version: 1.0.0

---
name: shopify-variant-option-normalizer
displayName: Variant Option Normalizer
description: >-
  Detects inconsistent variant option naming (Sm vs Small vs S) and
  bulk-corrects to a standard set.
version: 1.0.0
...
input:
  ...
  mapping:
    ...
    required: true
    description: >-
      Map of non-standard → canonical values (e.g., `{"Sm": "S", "small": "S",
      "Sml": "S"}`)
  filter:
    type: string
    required: false

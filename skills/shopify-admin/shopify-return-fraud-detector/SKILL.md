---
name: shopify-return-fraud-detector
displayName: Return Fraud Detector
description: >-
  Read-only: identifies customers with abnormal return behavior — high return
  rate, wardrobing patterns, or serial returner profiles — for manual review.
version: 1.0.0
category: returns
runtime:
  type: llm
...
input:
  ...
  min_orders:
    ...
    required: false
    description: >-
      Minimum lifetime orders for a customer to be evaluated (avoid penalizing
      one-off accidents)

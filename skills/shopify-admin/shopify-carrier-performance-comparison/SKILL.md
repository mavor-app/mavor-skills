---
name: shopify-carrier-performance-comparison
displayName: Carrier Performance Comparison
description: >-
  Read-only: compares delivery times and shipping costs across carriers used in
  fulfillments to inform carrier mix and contract decisions.
version: 1.0.0

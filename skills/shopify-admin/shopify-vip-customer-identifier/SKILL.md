---
name: shopify-vip-customer-identifier
displayName: Vip Customer Identifier
description: >-
  Identifies top-spending customers (top N% by lifetime value or order
  frequency) and exports a VIP candidate list; optionally tags qualified
  customers as VIPs.
version: 1.0.0
category: marketing
runtime:
...
input:
  ...
  rank_by:
    ...
    required: false
    description: >-
      Ranking strategy: `spend` (lifetime value), `frequency` (order count), or

---
name: shopify-price-elasticity-analyzer
displayName: Price Elasticity Analyzer
description: >-
  Read-only: analyzes the relationship between product pricing and sales
  velocity to identify optimal price points and price-sensitive products.
version: 1.0.0

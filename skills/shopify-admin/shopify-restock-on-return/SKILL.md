---
name: shopify-restock-on-return
displayName: Restock On Return
description: >-
  For approved/closed returns, restocks inventory at the return location by
  adjusting on-hand quantities for each returned line item.
version: 1.0.0
category: returns
runtime:
  type: llm
...
input:
  ...
  location_id:
    ...
    required: false
    description: >-
      If set, restock only returns whose inventory destination matches this
      location GID

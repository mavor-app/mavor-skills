---
name: shopify-cogs-completeness-audit
displayName: Cogs Completeness Audit
description: >-
  Read-only: identifies products and variants that are missing
  inventoryItem.unitCost so margin and inventory valuation reports stay
  accurate.
version: 1.0.0
...
input:
  ...
  include_zero_cost:
    ...
    required: false
    description: >-
      Treat `unitCost = 0` as missing (recommended; zero cost is rarely
      intentional)
  only_stocked:
    type: boolean
    required: false

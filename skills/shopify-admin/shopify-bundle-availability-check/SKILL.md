---
name: shopify-bundle-availability-check
displayName: Bundle Availability Check
description: >-
  Read-only: for native bundle products and metafield-defined bundles, verifies
  every component variant has sufficient stock to fulfill the bundle's effective
  availability.
version: 1.0.0
...
input:
  ...
  safety_stock:
    ...
    required: false
    description: >-
      Treat component as out-of-stock if on-hand minus this buffer is below
      required
  only_listed:
    type: boolean
    required: false

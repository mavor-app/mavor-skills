---
name: shopify-wismo-bulk-status-report
displayName: Wismo Bulk Status Report
description: >-
  Identify orders at risk of generating WISMO support tickets: shipped orders
  with stale tracking, and unfulfilled orders past their SLA window.
version: 1.0.0
...
input:
  ...
  stale_tracking_days:
    ...
    required: false
    description: >-
      Flag shipped orders where the last fulfillment was created more than this
      many days ago (proxy for stale tracking)
  limit:
    type: number
    required: false
